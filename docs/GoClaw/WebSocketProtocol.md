...
| `config.permissions.list`   | `{agentId, configType?}`                                                   |
| `config.permissions.grant`  | `{agentId, scope, configType, userId, permission, grantedBy?, metadata?}`  |
| `config.permissions.revoke` | `{agentId, scope, configType, userId}`                                     |
...
| `teams.tasks.delete-bulk`       | `{teamId, taskIds}`                                                    |
